...
export default function OtpLogin() {
  ...
  return (
    <AuthLayout>
      ...
      <h1 className="text-3xl font-extrabold tracking-[-0.035em] text-text-primary">Login with a one-time code</h1>
      <p className="mt-3 text-sm leading-6 text-text-secondary">
        Enter the email connected to your Coach Foska account. We will send you a six-digit code.
      </p>

    ...
    <section className="overflow-hidden rounded-2xl border border-outline bg-surface-elevated">
      ...
      {open && (
        <div className="border-t border-outline-subtle px-3 pb-4 sm:px-5">
          <div className={`hidden gap-2 py-3 text-[10px] font-bold uppercase tracking-wider text-text-secondary sm:grid ${timed ? 'grid-cols-[2.5rem_minmax(0,1fr)_5rem_3rem]' : 'grid-cols-[2.5rem_1fr_1fr_5rem_3rem]'}`}>
            <span>Séria</span>

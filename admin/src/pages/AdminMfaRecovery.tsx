  ...
  return (
    <AuthLayout>
      ...
      <p className="mt-3 text-sm leading-6 text-text-secondary">
        Supabase does not provide recovery codes. Ask an authorized Coach Foska operator to verify your identity and reset the lost factor. Never send a one-time code or setup key by email or chat.
      </p>
      <div className="mt-6 rounded-2xl border border-outline-subtle bg-surface p-5">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6 text-text-secondary">
          ...
          <li>The lost factor is removed using the protected recovery procedure.</li>
